...
show_help() {
    ...
    echo "  list-models          List available models for a provider"
    echo "  browse-models        Interactively browse and select models for a provider"
    echo "  set-default          Set default model for a provider"
    echo "  help                 Show this help message"
    echo "  version              Show version information"
    echo ""
    echo "Options:"
    ...
    echo "  curllm list-models --provider gemini"
    echo "  curllm browse-models --provider gemini"
    echo "  curllm set-default --provider gemini --model gemini-1.5-pro"
...
show_verbose_help() {
    ...
    echo ""
    echo "  list-models"
    echo "      List available models for a provider"
    echo "      Options:"
    echo "        --provider    Specify provider (required)"
    echo ""
    echo "  browse-models"
    echo "      Interactively browse and select models for a provider"
    echo "      Options:"
    echo "        --provider    Specify provider (required)"
    echo ""
    echo "  set-default"
    echo "      Set default model for a provider"
    echo "      Options:"
    echo "        --provider    Specify provider (required)"
    echo "        --model       Specify model (required)"
    echo ""
    echo "  help"
    ...
    echo ""
    echo "  # List models for a provider"
    echo "  curllm list-models --provider gemini"
    echo ""
    echo "  # Interactively browse models for a provider"
    echo "  curllm browse-models --provider gemini"
    echo ""
    echo "  # Set default model for a provider"
    echo "  curllm set-default --provider gemini --model gemini-1.5-pro"
